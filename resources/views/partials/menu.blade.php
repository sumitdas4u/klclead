    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('setting_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/lead-statuses*") ? "menu-open" : "" }} {{ request()->is("admin/lead-status-groups*") ? "menu-open" : "" }} {{ request()->is("admin/lead-followups*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('lead_status_group_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.lead-status-groups.index") }}" class="nav-link {{ request()->is("admin/lead-status-groups") || request()->is("admin/lead-status-groups/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">

                                        </i>
                                        <p>
                                            {{ trans('cruds.leadStatusGroup.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
                            @can('lead_followup_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.lead-followups.index") }}" class="nav-link {{ request()->is("admin/lead-followups") || request()->is("admin/lead-followups/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">

                                        </i>
                                        <p>
                                            {{ trans('cruds.leadFollowup.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
