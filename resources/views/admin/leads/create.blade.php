    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.leads.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('whatsapp_no') ? 'is-invalid' : '' }}" type="text" name="whatsapp_no" id="whatsapp_no" value="{{ old('whatsapp_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alternative_number') ? 'is-invalid' : '' }}" type="text" name="alternative_number" id="alternative_number" value="{{ old('alternative_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('localtion') ? 'is-invalid' : '' }}" type="text" name="localtion" id="localtion" value="{{ old('localtion', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('utm') ? 'is-invalid' : '' }}" type="text" name="utm" id="utm" value="{{ old('utm', '') }}">
                @if($errors->has('utm'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('followup_date') ? 'is-invalid' : '' }}" type="text" name="followup_date" id="followup_date" value="{{ old('followup_date') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('assign_to') ? 'is-invalid' : '' }}" name="assign_to_id" id="assign_to_id">
                    @foreach($assign_tos as $id => $entry)
                        <option value="{{ $id }}" {{ old('assign_to_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
